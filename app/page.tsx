...
import { Github, User, Users, BarChart3, TrendingUp, Code, Star, GitFork, ArrowRight, Sparkles } from 'lucide-react'
  ...
  const tools = [
    {
      ...
      description: 'Get detailed insights into any GitHub user\'s profile, repositories, and activity metrics.',
      icon: User,
      color: 'bg-blue-500',
      features: ['Profile Information', 'Repository Statistics', 'Language Distribution', 'Activity Metrics']
    },
    {
      id: 'compare-profiles',
      title: 'Compare Profiles',
      description: 'Compare two GitHub profiles side-by-side for hiring decisions and team analysis.',
      icon: Users,
      color: 'bg-green-500',
      features: ['Side-by-side Comparison', 'Metrics Analysis', 'Winner Indicators', 'Hiring Insights']
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-2xl font-bold text-gray-900">GitHub Toolkit</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            A comprehensive suite of tools for analyzing GitHub profiles, comparing developers, 
            and gaining insights into repository statistics and team performance.
          </p>
            ...
            return (
              <div
                ...
                className={`card cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-105 ${
                  tool.comingSoon ? 'opacity-60 cursor-not-allowed' : 'hover:border-primary-300'
                }`}
              >
        ...
        <div className="mt-16 bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Why Choose GitHub Toolkit?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Get detailed insights into profiles, repositories, and team performance with beautiful visualizations.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Compare developers side-by-side with clear metrics and winner indicators for hiring decisions.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Access live data from GitHub API with up-to-date information and comprehensive metrics.</p>
            </div>
          </div>
        </div>
      </main>
